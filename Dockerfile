...
RUN mkdir /var/lock && \
    ...
    uci commit uhttpd && \
	opkg install luci-base luci-mod-admin-full luci-theme-bootstrap luci-i18n-base-en luci-i18n-firewall-en luci-i18n-base-fr luci-i18n-firewall-fr opkg install luci-i18n-base-zh-cn  luci-proto-ipv6 luci-app-openvpn && \
